...
2. Clone your fork: `git clone https://github.com/YOUR-USERNAME/deepseek-squad.git`
3. Add the upstream repository: `git remote add upstream https://github.com/jimmyflatting/deepseek-squad.git`
